...
Package files can also be downloaded directly from [nequip.net](https://www.nequip.net/) and are automatically cached. See [Downloading models from nequip.net](./workflow.md/#downloading-models-from-nequipnet) for details.
